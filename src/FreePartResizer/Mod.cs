...
public class Mod : MelonMod
{
    ...
    private static readonly IReadOnlyList<Rule> _rules = new List<Rule>
    {
        ...
        new()
        {
            ...
            CurrentDims  = new Vector3(13f, 0.5f, 13f),
            DefaultDims  = PartDescriptorProcedural.DefaultDims.Min,
            UnitMaxDims  = new Vector3(500f, 500f, 500f),
        ...
        new()
        {
            ...
            CurrentDims  = new Vector3(0f, 0.5f, 13f),
            DefaultDims  = PartDescriptorProcedural.DefaultDims.Min,
        ...
        new()
        {
            ...
            CurrentDims  = new Vector3(8f, 8f, 13f),
            DefaultDims  = PartDescriptorProcedural.DefaultDims.Min,
            UnitMaxDims  = new Vector3(500f, 500f, 500f),
        ...
        new()
        {
            ...
            CurrentDims  = new Vector3(8f, 8f, 0.5f),
            DefaultDims  = PartDescriptorProcedural.DefaultDims.Min,
        ...
        new()
        {
            ...
            CurrentDims  = new Vector3(8f, 8f, 1f),
            DefaultDims  = PartDescriptorProcedural.DefaultDims.Min,
        ...
        new()
        {
            ...
            CurrentDims  = new Vector3(8f, 0f, 13f),
            DefaultDims  = PartDescriptorProcedural.DefaultDims.Min,
            UnitMaxDims  = new Vector3(500f, 0f, 500f),
            UnitMinDims  = new Vector3(0.1f, 0f, 0.5f),
        },
        new()
        {
            NameContains = new[] { "Sphere Resizable" },
            CurrentDims  = new Vector3(0f, 0f, 8f),
            DefaultDims  = PartDescriptorProcedural.DefaultDims.Min,
        ...
        new()
        {
            ...
            CurrentDims  = new Vector3(8f, 8f, 0.1f),
            DefaultDims  = PartDescriptorProcedural.DefaultDims.Min,
            UnitMaxDims  = new Vector3(500f, 500f, 500f),
            UnitMinDims  = new Vector3(1f, 1f, 0.5f),
        },
        new()
        {
        ...
        new()
        {
            ...
            CurrentDims  = new Vector3(1f, 0.5f, 8f),
            DefaultDims  = PartDescriptorProcedural.DefaultDims.Min,
        ...
        new()
        {
            ...
            CurrentDims  = new Vector3(0.5f, 0f, 14f),
            DefaultDims  = PartDescriptorProcedural.DefaultDims.Min,
            UnitMaxDims  = new Vector3(0.5f, 0f, 500f),
        ...
        new()
        {
            ...
            CurrentDims  = new Vector3(0.5f, 0f, 2f),
            DefaultDims  = PartDescriptorProcedural.DefaultDims.Min,
            UnitMaxDims  = new Vector3(0.5f, 0f, 500f),
            UnitMinDims  = new Vector3(0.5f, 0f, 0.1f),
        },
        ...
        new()
        {
            ...
            CurrentDims  = new Vector3(8f, 0.75f, 0f),
            DefaultDims  = PartDescriptorProcedural.DefaultDims.Min,
        ...
        new()
        {
            ...
            CurrentDims  = new Vector3(1f, 0.5f, 14f),
            DefaultDims  = PartDescriptorProcedural.DefaultDims.Min,
            UnitMaxDims  = new Vector3(1f, 0.5f, 500f),
            UnitMinDims  = new Vector3(1f, 0.5f, 1f),
        },
